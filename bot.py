...
class Samuel:
    ...
    def login(self):
        ...
        sleep(2)
        self.bot.get('https://www.youtube.com/c/SamMillerVlogs/videos')
    ...
    def start_liking(self):
        ...
        for i in range(len(links)):
            ...
            if check_liked.get_attribute("class") == 'style-scope ytd-menu-renderer force-icon-button style-text':
                ...
                print("Video already liked. You are a good Noob Coder.\n")


username = str(input('Enter Username'))
password =  str(input('Enter Password'))
noob_coders = Samuel(username,password)
noob_coders.login()
noob_coders.start_liking() 
